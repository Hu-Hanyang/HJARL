...
class CartPoleDistbEnv(BenchmarkEnv):
    ...
    # # Hanyang: add method _get_state() to get the real state of the current moment
    # def _get_state(self):
    #     '''Returns the current observation (state) of the environment.
    ...
    def _get_info(self):
        ...
        # Hanyang: record the current HJ disturbances info
        info['distb_type'] = self.distb_type
        info['distb_level'] = self.distb_level
        return info
