'''Base environment class module for the reach-avoid game using relative polar coordinate system.
...
class RelativeRAGameEnv(BaseRLGameEnv):
    #TODO: Use relative polar coordinates as the observation space, not started yet, 2024.7.9
